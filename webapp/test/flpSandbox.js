    ...
    services: {
                ...
                tiles: [
                  {
                    ...
                    properties: {
                      title: 'UI5 training',
                      targetURL: '#ui5trainingzui5training-display',
                    },
                  },
                ],
              },
      ...
      ClientSideTargetResolution: {
        adapter: {
          config: {
            inbounds: {
              'ui5trainingzui5training-display': {
                semanticObject: 'ui5trainingzui5training',
                action: 'display',
                description: 'A Fiori UI5 training application.',
                title: 'UI5 training',
                signature: {
                  parameters: {},
                },
                resolutionResult: {
                  ...
                  additionalInformation: 'SAPUI5.Component=ui5.training.zui5training',
                  url: sap.ui.require.toUrl('ui5/training/zui5training'),
                },
              },
            },
          },
